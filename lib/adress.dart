          ...
          child: Column(
            children: [
              ...
              SizedBox(
                width: 350.w,
                child: AutoSizeText(
                  '''Veuillez insérer l'adresse où vous souhaitez recevoir votre commande de google map.''',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 18.sp,
                    color: Colors.black,
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    List<Location> locations =
                        await locationFromAddress(adress);

                    List<Panier>? list = DatabaseService.list;

                    await DatabaseService(uid: user!.uid)
                        .writeCommande(locations[0]);
