...
class Click_restaurant extends StatefulWidget {
  ...
  const Click_restaurant({Key? key,required this.restaurant_id,required this.image,required this.name}) : super(key: key);
                    ...
                    Expanded(
                      child: TabBarView(children: [
                        for (var i in tableau)
                          Catego(restaurant_id: widget.restaurant_id, categorie: i , name: widget.name  , image: widget.image, ),
